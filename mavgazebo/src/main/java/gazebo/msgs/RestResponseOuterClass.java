...
public final class RestResponseOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              gazebo.msgs.RestResponseOuterClass.RestResponse.Type value = gazebo.msgs.RestResponseOuterClass.RestResponse.Type.valueOf(rawValue);
              if (value == null) {
    ...
    @java.lang.Override public gazebo.msgs.RestResponseOuterClass.RestResponse.Type getType() {
      @SuppressWarnings("deprecation")
      gazebo.msgs.RestResponseOuterClass.RestResponse.Type result = gazebo.msgs.RestResponseOuterClass.RestResponse.Type.valueOf(type_);
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        gazebo.msgs.RestResponseOuterClass.RestResponse parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (gazebo.msgs.RestResponseOuterClass.RestResponse) e.getUnfinishedMessage();
